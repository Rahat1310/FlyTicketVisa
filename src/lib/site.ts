...
export const siteConfig = {
  ...
  whatsappMessage: "Assalamu alaikum. I would like help with a visa / air ticket inquiry.",
  messengerUrl: "https://m.me/flyticketvisa",
  email: "support@flyvisapoints.com",
  address: {
    lines: ["Monichottor, Shaheb Bazar", "Rajshahi, Bangladesh"],
    mapEmbedUrl:
  ...
  heroImageUrl: "https://res.cloudinary.com/blvrawlp/image/upload/v1784738490/hero_visa_pmfnzz.png",
} as const;
